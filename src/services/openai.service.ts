...
function buildAiSalesSystemPrompt(moodInstruction: string): string {
  return [
    ...
    "",
    "IMAGENS",
    "- Se o cliente pedir foto, imagem ou mostrar produto, voc? pode decidir enviar a imagem do produto.",
    "- S? diga que vai enviar foto se o item existir no cat?logo e tiver imagem dispon?vel.",
    "- Se o cliente pedir v?rias fotos, voc? pode retornar v?rios nomes em media.product_names.",
    "- Voc? est? falando no pr?prio WhatsApp do cliente; n?o pergunte se pode mandar 'por aqui'.",
    "- Ao enviar imagem, n?o cite estoque na legenda, salvo se o cliente tiver pedido isso.",
    "",
